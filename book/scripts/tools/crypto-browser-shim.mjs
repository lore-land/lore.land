/**
 * Browser stand-in for `node:crypto.createHash`, used only when bundling
 * spw-seed for the page. Nest-path / patch / stencil identity hashes need a
 * sync SHA-256; Web Crypto is async, so this file carries a compact one.
 */
