...
Current cache release token: `2026_09_16.A` (`book/scripts/modules/cache-context.mjs`, `build-chapters.mjs`).
...
- release token: `2026_09_16.A` (single source: `cache-context.mjs` + `build-chapters.mjs`)
- query key: `v`
- context key: `ctx`
