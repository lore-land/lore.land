...
Current cache release token: `2026_09_23.B` (`book/scripts/modules/cache-context.mjs`, `build-chapters.mjs`).
...
- release token: `2026_09_23.B` (single source: `cache-context.mjs` + `build-chapters.mjs`)
- query key: `v`
- context key: `ctx`
